      ...
      <main className={`${styles.page} bg-slate-50 text-slate-900`}>
        ...
        <section className="relative min-h-[92vh] flex items-center bg-[#0a0a0f] overflow-hidden pb-20 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className={`${styles.fadeUp} flex flex-wrap items-center gap-4 mb-16`} style={d('.9s')}>
              <Link href="/?open=contact" className="px-8 py-4 rounded-full bg-siot-500 hover:bg-siot-600 text-white font-bold transition-all">도입 문의하기</Link>
              <Link href="/#siot" className="px-8 py-4 rounded-full border-2 border-white/15 text-white/80 font-bold hover:border-siot-500 hover:text-siot-400 transition-all">홈에서 살펴보기</Link>
            </div>
            <div className={`${styles.fadeUp} grid grid-cols-3 max-w-xl gap-6`} style={d('1.1s')}>
              <div>
                ...
                <p className="text-xs md:text-sm text-white/40 font-medium mt-1">제어 안정성</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-black text-white"><CountUp target={1} />초</p>
                <p className="text-xs md:text-sm text-white/40 font-medium mt-1">모니터링 주기</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-black text-white"><CountUp target={0} /></p>
                <p className="text-xs md:text-sm text-white/40 font-medium mt-1">배선 공사</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 md:py-32 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto space-y-24">
            ...
            <Reveal className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <p className="text-siot-500 text-xs font-black tracking-widest uppercase mb-4">01 — Main Control</p>
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>1초 단위 실시간 모니터링</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>이상 신호 즉시 감지·알림</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>중앙 집중식 관제</li>
                </ul>
              </div>
              <div className="rounded-2xl overflow-hidden border border-slate-200/70 shadow-xl bg-white">
                <Image src="/img/siot3.png" alt="시옷 메인 관제 화면" width={1440} height={1674} className="w-full h-auto block" />
              </div>
            </Reveal>

            <Reveal className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div className="lg:order-2">
                <p className="text-siot-500 text-xs font-black tracking-widest uppercase mb-4">02 — Unified Control</p>
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>조명 · 블라인드 · 공조 통합</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>장치 무제한 확장</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>모바일 · 웹 어디서나</li>
                </ul>
              </div>
              <div className="lg:order-1 rounded-2xl overflow-hidden border border-slate-200/70 shadow-xl bg-white">
                <Image src="/img/siot1.png" alt="시옷 통합 제어 대시보드" width={1440} height={1144} className="w-full h-auto block" />
              </div>
            </Reveal>

            <Reveal className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <p className="text-siot-500 text-xs font-black tracking-widest uppercase mb-4">03 — Scene Mode</p>
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>상황별 프리셋 저장</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>모든 장치 동시 전환</li>
                  <li className="flex gap-3"><span className="text-siot-500 font-black">—</span>무한 커스터마이징</li>
                </ul>
              </div>
              <div className="rounded-2xl overflow-hidden border border-slate-200/70 shadow-xl bg-white">
                <Image src="/img/siot2.png" alt="시옷 장면 모드 프리셋" width={1440} height={900} className="w-full h-auto block" />
              </div>
            </Reveal>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-y border-slate-200/60">
          <Reveal className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <Link href="/about" className="shrink-0 px-7 py-3.5 rounded-full border-2 border-slate-200 font-bold text-sm text-slate-600 hover:border-siot-500 hover:text-siot-600 transition-all">구축 프로세스 보기</Link>
            </div>
          </Reveal>
        </section>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <Reveal className="max-w-6xl mx-auto rounded-3xl bg-[#0a0a0f] text-white p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
            ...
            <Link href="/?open=contact" className="shrink-0 px-8 py-4 rounded-full bg-siot-500 hover:bg-siot-600 text-white font-bold transition-all relative">무료 상담 신청</Link>
          </Reveal>
        </section>
      </main>
